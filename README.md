...
- 3D 棋盤旋轉、俯仰、縮放與自動旋轉
- 黑棋禁手：長連、雙四、雙三
- 計時、悔棋、重做、AI 提示(0906 起提示與「大師」檔走 `ai-engine.js`:成五 → 擋五 → 連續衝四 → 活三連殺 → 擋活三 → 深算,提示會說理由)
- 版本號徽章與改版簡歷(左欄底摺疊;右下角顯示這台裝置實際執行中的版本)
- 電腦思考在背景執行緒(Web Worker)跑,不卡畫面;「困難」會擋活三、破連四(進攻仍會犯錯)
- 棋譜匯入、匯出、分享連結與回放
- 殘局解謎：84 題、四級（入門 16／進階 18／高手 27／大師 23），連續衝四、活三＋衝四、守備三種題型，
